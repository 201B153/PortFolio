...
const GithubProfileCard = ({ prof }) => {
	...
	<div className="position-relative background-greetings-section">
		<Card className=" section-lg bg-gradient-info shadow-lg border-0">
			<Container className="background-201b153">
				<div className="p-2">
					<Row className="">
						...
						<Col lg="8" className="order-lg-1">
							...
							<h2 className="text-black">Reach Out to ME! :)</h2>
                  ...
                  >
                    ...
                    <span className="nav-link-inner--text  ml-1">{prof.location}</span>
                  </Button>&nbsp;
				  <Button
                    className="btn-icon"
                    color="transparent"
                  ...
                  >
                    ...
                    <span className="icon-btn"><SocialLinks /></span>
                  </Button>
