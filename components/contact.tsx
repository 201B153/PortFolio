        ...
        >
          ...
          <div className="flex flex-wrap justify-center items-center">
            <button
              ...
              className={`${styles.sectionSubText} green-pink-gradient py-3 px-8 rounded-xl outline-none w-fit text-white font-semibold hover:shadow-2xl hover:shadow-purple-700`}
            >
